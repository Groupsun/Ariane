...
class instr_scan (Module):
    ...
    is_rvc = (io.instr_i[1:0] != U(3))  #还不确定这类[n:m]要怎么在pyhcl中表达
    ...
    is_jal_r = (instr_i[15:13] == riscv::OpcodeC2JalrMvAdd)
                        & (io.instr_i[6:2] == U.w(5)(0))
                        & (io.instr_i[1:0] == riscv::OpcodeC2)
                        & is_rvc
    ...
    io.rvc_branch_o = ((io.instr_i[15:13] == riscv::OpcodeC1Beqz) | (io.instr_i[15:13] == riscv::OpcodeC1Bnez))
                        & (io.instr_i[1:0] == riscv::OpcodeC1)
                        & is_rvc
